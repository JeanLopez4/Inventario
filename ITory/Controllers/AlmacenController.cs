...
namespace ITory.Controllers
{
    public class AlmacenController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idAlmacen,Nombre,Estado")] Almacen almacen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idAlmacen,Nombre,Estado")] Almacen almacen)
        {
            if (ModelState.IsValid)
            {
